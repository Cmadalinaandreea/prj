...
export default function Footer() {
  return (
    ...
    <div className="mx-auto max-w-6xl items-center justify-between px-4 md:flex lg:px-0">
      ...
      <img className="w-20" src="../favicon.ico"/>
        <span className="ml-4 text-lg font-bold">e-learning</span>
      </div>
      <div className="mt-4 md:mt-0">
        <p className="text-sm font-medium text-gray-500">© 2023 e-learning. All rights reserved.</p>
      </div>
    </div>
  </footer>
  )
